...
export class TagService {
  tags: Tag[] = [
    ...
    { name: 'apex-legends', icon: 'fas fa-gamepad', description: 'Find the best Apex Legends bots from our list.' },
    { name: 'chat', icon: 'fas fa-comments', description: 'Find the best chat bots from our list.' },
    { name: 'csgo', icon: 'fas fa-gamepad', description: 'Find the best CSGO bots from our list.' },
    ...
    { name: 'fortnite', icon: 'fas fa-gamepad', description: 'Find the best Fortnite bots from our list.' },
    { name: 'fun', icon: 'fas fa-grin-tears', description: 'Find the most fun bots from our list.' },
    { name: 'league-of-legends', icon: 'fas fa-gamepad', description: 'Find the best League of Legends bots from our list.' },
    ...
    { name: 'minecraft', icon: 'fas fa-gamepad', description: 'Find the best Minecraft bots from our list.' },
    ...
    { name: 'pokemon', icon: 'fas fa-gamepad', description: 'Find the best Pokemon bots from our list.' },
    { name: 'pugb', icon: 'fas fa-gamepad', description: 'Find the best PUBG bots from our list.' },
    { name: 'reddit', icon: 'fab fa-reddit', description: 'Find the best Reddit bots from our list.' },
    { name: 'roblox', icon: 'fas fa-gamepad', description: 'Find the best Roblox bots from our list.' },
    { name: 'rocket-league', icon: 'fas fa-gamepad', description: 'Find the best Rocket League bots from our list.' },
    ...
    { name: 'runescape', icon: 'fas fa-gamepad', description: 'Find the best Runescape bots from our list.' },
    ...
    { name: 'valorant', icon: 'fas fa-gamepad', description: 'Find the best Valorant bots from our list.' },
